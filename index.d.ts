...
interface ThermalPrinterOptions {
    ...
    */
    printBarcode(data: string, type?: number, settings?: {
        hriPos?: number;
        hriFont?: number;
        width?: number;
        height?: number;
...
declare function DatePrinter(config: options): ThermalPrinterOptions;
